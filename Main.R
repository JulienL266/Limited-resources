################################################################################################
################################################################################################
###Finite population simulation to verify identification
################################################################################################
################################################################################################

#See Function.R for detailed descriptions of functions

##Set-up########################################################################################
#####1. NPSEM with single time-point
#####2. n individuals
#####3. Single time-point (L, A, Z, R, Y)
########a. L's independent and identically distributed at baseline
########b. Z's iid
########c. R's affected by other people's L's, iid errors
########d. A's affected by other people's L's, iid errors, resource constraint. 
########e. Y's independent at baseline, with fixed values across draws

##Simulating data and computing results#####################################################################################
